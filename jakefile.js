...
desc('Copy WebSocketMain.swf.');
task('copySwf', function() {
	fs.cp(srcDir + 'WebSocketMain.swf', distDir + 'WebSocketMain.swf', function() {
		console.log('Copied WS fallback swf to ' + distDir + 'WebSocketMain.swf');
	});
})